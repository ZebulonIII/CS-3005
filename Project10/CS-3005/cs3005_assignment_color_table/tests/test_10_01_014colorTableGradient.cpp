...
TEST_F( ColorTableGradientTest, doesNotChangeIfPositionIsTooLow ) {
  /* Setup */
  // Done automatically

  /* Stimulus */
  color_table.insertGradient( gradient_1, gradient_2, -1, 3 );
...
TEST_F( ColorTableGradientTest, doesNotChangeIfPositionIsTooHigh ) {

  /* Setup */
  // Done automatically

  /* Stimulus */
  color_table.insertGradient( gradient_1, gradient_2, 3, 8 );
...
TEST_F( ColorTableGradientTest, setsGradientIncludingPosition0 ) {
  /* Setup */
  // Done automatically
  ...
  Color e0( 0, 0, 0 );
  Color e1( 66, 66, 66 );
  Color e2( 133, 133, 133 );
  Color e3( 200, 200, 200 );

  /* Comparison */
  EXPECT_EQ( e0, color_table[ 0 ] );
  EXPECT_EQ( e1, color_table[ 1 ] );
  EXPECT_EQ( e2, color_table[ 2 ] );
  EXPECT_EQ( e3, color_table[ 3 ] );
...
TEST_F( ColorTableGradientTest, setsGradientIncludingLastPosition ) {
  /* Setup */
  // Done automatically
  ...
  EXPECT_EQ( e4, color_table[ 4 ] );
  EXPECT_EQ( e5, color_table[ 5 ] );
  EXPECT_EQ( e6, color_table[ 6 ] );
  EXPECT_EQ( e7, color_table[ 7 ] );
