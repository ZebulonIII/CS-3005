...
TEST_F( ColorSetterTest, setsZeroRed ) {
  ...
  /* Comparison */
  EXPECT_EQ( 0, color_const.getRed( ) );
...
TEST_F( ColorSetterTest, setsZeroGreen ) {
  ...
  /* Comparison */
  EXPECT_EQ( 0, color_const.getGreen( ) );
...
TEST_F( ColorSetterTest, setsZeroBlue ) {
...
TEST_F( ColorSetterTest, doesNotSetChannelTooLowVeryLow ) {

  /* Setup */
  // Done automatically

  /* Stimulus */
  const int channel = -1000000;
  color.setChannel( channel, parameterized_blue );
  const Color& color_const = color;
...
TEST_F( ColorSetterTest, doesNotSetChannelTooHighVery ) {

  /* Setup */
  // Done automatically

  /* Stimulus */
  const int channel = 3000000;
  color.setChannel( channel, parameterized_blue );
  const Color& color_const = color;
...
TEST_F( ColorSetterTest, setsZeroValuesViaChannel ) {
  ...
  /* Comparison */
  EXPECT_EQ( 0, color_const.getChannel( 0 ) );
  EXPECT_EQ( 0, color_const.getChannel( 1 ) );
  EXPECT_EQ( 0, color_const.getChannel( 2 ) );
