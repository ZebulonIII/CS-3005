...
void ColorTable::insertHSVColorGradient(const double& h1, const double& s1, const double& v1, const double& h2, const double& s2, const double& v2, const size_t& position1, const size_t& position2) {
	Color color1;
