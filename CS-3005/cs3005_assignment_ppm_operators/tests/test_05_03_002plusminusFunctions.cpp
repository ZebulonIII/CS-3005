...
class plusAndMinusFunctionsTest : public ::testing::Test {
protected:
...
TEST_F( plusAndMinusFunctionsTest, plusDoesNotModifyParameters ) {
  ...
  const PPM& b = ppm_b;
  PPM ppm_result;
  plus( mInputStream, mOutputStream, a, b, ppm_result );
...
TEST_F( plusAndMinusFunctionsTest, plusReturnsResult ) {
...
TEST_F( plusAndMinusFunctionsTest, minusDoesNotModifyParameters ) {
  ...
  const PPM& b = ppm_b;
  PPM ppm_result;
  minus( mInputStream, mOutputStream, a, b, ppm_result );
...
TEST_F( plusAndMinusFunctionsTest, minusReturnsResult ) {
