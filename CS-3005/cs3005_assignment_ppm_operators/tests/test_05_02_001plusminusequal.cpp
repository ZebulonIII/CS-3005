...
class PPMPlusMinusEqualTest : public ::testing::Test {
protected:
...
TEST_F( PPMPlusMinusEqualTest, plusEqualModifiesLHS ) {
...
TEST_F( PPMPlusMinusEqualTest, plusEqualReturnsModifiedLHS ) {
...
TEST_F( PPMPlusMinusEqualTest, plusEqualRecievesConstRHS ) {
...
TEST_F( PPMPlusMinusEqualTest, minusEqualModifiesLHS ) {
...
TEST_F( PPMPlusMinusEqualTest, minusEqualReturnsModifiedLHS ) {
...
TEST_F( PPMPlusMinusEqualTest, minusEqualRecievesConstRHS ) {
