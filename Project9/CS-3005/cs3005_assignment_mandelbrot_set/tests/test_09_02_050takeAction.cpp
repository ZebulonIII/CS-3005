...
class ComplexFractalTakeActionTest : public ::testing::Test {
protected:
...
TEST_F( ComplexFractalTakeActionTest, acceptsJuliaCommand ) {
...
TEST_F( ComplexFractalTakeActionTest, acceptsMandelbrotCommand ) {
